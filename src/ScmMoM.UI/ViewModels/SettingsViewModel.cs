...
public class SettingsViewModel : ReactiveObject
{
    ...
    public SettingsViewModel(ConfigService configService)
    {
        ...
        var account = cfg.Accounts.FirstOrDefault();
        _organization = account?.Organization ?? string.Empty;
        _repositoriesCsv = string.Join(", ", account?.Repositories ?? new());
    ...
    private void Save()
    {
        ...
        if (account != null)
        {
            account.Organization = Organization.Trim();
